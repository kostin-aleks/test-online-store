...
PRODUCT_DATA = [
    {
        ...
        'description': '''
        Шолом Salewa Pura Helmet є надійним та універсальним.
        Він гарантує необхідний захист під час скелелазіння та активного відпочинку.
        Добре регулюється та легко підлаштовується під індивідуальні особливості.
        Підійде як для жінок, так і для чоловіків. Є і дитячі варіації.''',
        'details': [
            'міцна і зручна внутрішня оболонка із пінополістиролу',
    ...
    },
    {
        ...
        'description': '''
        Робоча каска Plasma Work бренду Singing Rock Singing Rock Plasma Work -
        легка та міцна каска для промальпу, будівельних та висотно-монтажних робіт.
        Вона легко регулюється для комфортної посадки на голові
        та компактно складається для перевезення.
        ''',
    ...
    },
    {
        ...
        'description': '''
        Жумар Black Diamond Index Ascender - пристрій для підйому мотузкою,
        сконструйований для роботи на важких ділянках, у важких умовах протягом усього
        маршруту в будь-яку погоду. Новий курок затискача дозволяє легко пересувати
        його, що додає швидкості та маневреності. Агресивні зубці для надійного
        фіксування на зледенілій мотузці. Є можливість працювати з широким діапазоном мотузок,
        лівою чи правою (різні модифікації) рукою.''',
    ...
    },
    {
        ...
        'description': '''
        Нова серія спальних мішків від Turbat задовільнить найвимогливіших користувачів,
        які потребують максимального комфорту при мінімальному об'ємі та вазі.
        Легкий і надзвичайно практичний трисезонний спальник для використання у
        міжсезонний період.
        Хороші термоізоляційні властивості досягаються завдяки
        натуральному матеріалу наповнювача - гусячому пуху високого класу.
        Такий наповнювач перевершує усі синтетичні аналоги за показниками
        теплоізоляції на одиницю ваги.
        Добре компресується у зручний мішок.
        Компактна та практична форма, легкість у використанні є перевагами даної моделі.
...
Призначення: гірський туризм, піший туризм, кемпінг, велотуризм, альпінізм.''',
        'details': ['компактна модель',
                    ...
                    'добре компресується',
                    'пружність пуху FP 750, показники підтверджені ' +
                    'сертифікатом швейцарського інституту IDFL Europe AG'],
